...
V3.7.2 — Gradio API Discovery Fix
- endpoint پرو دیگر حدس زده نمی‌شود؛ از client.view_api() کشف می‌شود.
- اول /try_on یا endpoint متناظر با 8 پارامتر ورودی پیدا می‌شود.
