...
function buildTryonPrompt(items){
  ...
  return `این تصویر، ست پیشنهادی Wardrobe من است: ${names}.

قانون ثابت پرو لباس:
تصویر مانکن مرجع موجود در همین چت، هویت ثابت و غیرقابل‌تغییر این پروژه است. همین ست را فقط روی همان مانکن مرجع پرو کن.

به هیچ وجه تغییر نده:
چهره، فرم سر و صورت، مو و خط رویش مو، ابروها، چشم‌ها، بینی، لب‌ها، فک، گوش‌ها، رنگ و بافت پوست، ته‌ریش، سن ظاهری، قد ظاهری، عرض شانه، گردن، سینه، شکم، کمر، لگن، بازوها، دست‌ها، ران‌ها، ساق‌ها، نسبت طول دست‌وپا و تناسب کلی بدن.

مانکن را دوباره طراحی، بازتفسیر، زیباتر، جوان‌تر، لاغرتر، چاق‌تر یا عضلانی‌تر نکن. Pose، زاویه بدن و زاویه دوربین نیز همان تصویر مرجع باقی بماند مگر اینکه من صراحتاً درخواست دیگری بدهم.

تصویر این ست فقط مرجع لباس، کفش و اکسسوری است. اگر در تصاویر لباس شخص یا مدل دیگری وجود دارد، چهره و بدن او را کاملاً نادیده بگیر. فقط لباس‌ها را با حفظ مدل، رنگ، جنس، طرح، فرم، فیت و جزئیاتشان روی مانکن ثابت جایگزین کن.

اولویت مطلق:
1) حفظ دقیق هویت چهره و فیزیک مانکن مرجع
2) حفظ Pose و تناسبات مانکن
3) دقت لباس، کفش و اکسسوری
4) سایر جزئیات تصویر

این یک ویرایش روی مانکن مرجع است، نه تولید یک شخص جدید. اگر بین دقت لباس و حفظ هویت مانکن تعارضی وجود داشت، حفظ مانکن همیشه اولویت دارد.`;
}
